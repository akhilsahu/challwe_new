  ...
  <body class="hold-transition login-page">
    ...
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <form action="<?php echo base_url();?>index.php/user/loginadmin" method="post" id="login_form" class="form-horizontal">
