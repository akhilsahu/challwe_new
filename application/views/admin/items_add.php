...
<div class="content-wrapper">
  <div class="row">
      <div class="col-md-10">
        <form method="post" action="<?php echo site_url();?>/admin/additems"  enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      ...
                      <input type="text" placeholder="Challwecoins" id="txt_challwecoins" name="txt_challwecoins" value="" class="form-control">
