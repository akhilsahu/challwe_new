                ...
                <div class="box-body table-responsive no-padding">
                  ...
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tr>
                      ...
                      <td><?php echo $val['txt_challwecoins'];?></td>
                      <td><img src="<?php echo base_url()."".$val['txt_filename'];?>" alt="Smiley face" height="42" width="42"></td>
                        ...
                        <td>
                          ...
                          <a href="<?php echo site_url().'/admin/edititems/'.$val['int_items_id']?>" class="btn btn-primary">Edit</a>

                          <a href="<?php echo site_url().'/admin/deleteditems/'.$val['int_items_id']?>" class="btn btn-danger">Delete</a>
