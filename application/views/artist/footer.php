<footer>
                        ...
                        <div class="widgetBox">
                            ...
                            <div class="widgetContent">
                                <div class="media-object">
                                    <div class="media-object-section">
                                        <div class="recent-img">
                                            <img src= "<?php echo base_url();?>assets/images/recent1.png" alt="recent">
                                ...
                                <div class="media-object">
                                    <div class="media-object-section">
                                        <div class="recent-img">
                                            <img src= "<?php echo base_url();?>assets/images/video-thumbnail/1.jpg" alt="recent">
                                            <a href="#" class="hover-posts">
                                                <span><i class="fa fa-play"></i></span>
                                            </a>
                                        </div>
                                ...
                                <div class="media-object">
                                    <div class="media-object-section">
                                        <div class="recent-img">
                                            <img src= "<?php echo base_url();?>assets/images/recent3.png" alt="recent">
                                            <a href="#" class="hover-posts">
                                                <span><i class="fa fa-play"></i></span>
                                            </a>
                                        </div>
            ...
            <div id="footer-bottom">
                <div class="logo text-center">
                    <img src="<?php echo base_url();?>assets/images/footerlogo.png" alt="footer logo">
                </div>
