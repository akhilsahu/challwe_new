                                                ...
                                                <div id="owl-demo-video" class="owl-carousel carousel" data-car-length="1" data-items="1" data-loop="true" data-nav="false" data-autoplay="true" data-autoplay-timeout="3000" data-dots="false">
                                                    <div class="item item-video thumb-border">
                                                        <figure class="premium-img">
                                                            <img src="<?php echo base_url();?>assets/images/widget-most2.png" alt="carousel">
                                                    ...
                                                    <div class="item item-video thumb-border">
                                                        <figure class="premium-img">
                                                            <img src="<?php echo base_url();?>assets/images/widget-most1.png" alt="carousel">
                                                            <a href="#" class="hover-posts">
                                                                <span><i class="fa fa-play"></i></span>
                                                            </a>
                                                        </figure>
                                                    ...
                                                    <div class="item item-video thumb-border">
                                                        <figure class="premium-img">
                                                            <img src="<?php echo base_url();?>assets/images/widget-most3.png" alt="carousel">
                                                            <a href="#" class="hover-posts">
                                                                <span><i class="fa fa-play"></i></span>
                                                            </a>
                                                        </figure>
                                    ...
                                    <div class="widgetBox">
                                        ...
                                        <div class="widgetContent">
                                            <div class="advBanner text-center">
                                                <a href="#"><img src="<?php echo base_url();?>assets/images/sideradv.png" alt="sidebar adv"></a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="widgetBox">
                                        ...
                                        <div class="widgetContent">
                                            <div class="media-object stack-for-small">
                                                <div class="media-object-section">
                                                    <div class="recent-img">
                                                        <img src= "<?php echo base_url();?>assets/images/category/category4.png" alt="recent">
                                                        <a href="#" class="hover-posts">
                                                            <span><i class="fa fa-play"></i></span>
                                                        </a>
                                                    </div>
                                            ...
                                            <div class="media-object stack-for-small">
                                                <div class="media-object-section">
                                                    <div class="recent-img">
                                                        <img src= "<?php echo base_url();?>assets/images/category/category2.png" alt="recent">
                                                        <a href="#" class="hover-posts">
                                                            <span><i class="fa fa-play"></i></span>
                                                        </a>
                                                    </div>
                                            ...
                                            <div class="media-object stack-for-small">
                                                <div class="media-object-section">
                                                    <div class="recent-img">
                                                        <img src= "<?php echo base_url();?>assets/images/sidebar-recent1.png" alt="recent">
                                                        <a href="#" class="hover-posts">
                                                            <span><i class="fa fa-play"></i></span>
                                                        </a>
                                                    </div>
                                            ...
                                            <div class="media-object stack-for-small">
                                                <div class="media-object-section">
                                                    <div class="recent-img">
                                                        <img src= "<?php echo base_url();?>assets/images/sidebar-recent2.png" alt="recent">
                                                        <a href="#" class="hover-posts">
                                                            <span><i class="fa fa-play"></i></span>
                                                        </a>
                                                    </div>
